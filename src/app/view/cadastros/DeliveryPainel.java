 ...
 * @author Dave
 */
public class DeliveryPainel extends javax.swing.JFrame {

    /**
     * Creates new form Produto
     */
    public DeliveryPainel() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeliveryPainel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeliveryPainel().setVisible(true);
            }
        });
    }
