 ...
 * @author Dave
 */
public class EntregaPainel extends javax.swing.JFrame {

    /**
     * Creates new form Produto
     */
    public EntregaPainel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Status Pedido ID");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EntregaPainel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EntregaPainel().setVisible(true);
            }
        });
    }
